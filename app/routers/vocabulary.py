...
@router.post("/api/generate-vocabulary", response_model=VocabularyResponse)
...
# HTMX 전용 엔드포인트들
@router.post("/htmx/generate-vocabulary", response_class=HTMLResponse)
...
@router.get("/htmx/vocabulary-list", response_class=HTMLResponse)
...
@router.post("/htmx/save-vocabulary", response_class=HTMLResponse)
...
@router.delete("/htmx/vocabulary/{word}", response_class=HTMLResponse)
...
@router.post("/htmx/validate-input", response_class=HTMLResponse)
...
@router.get("/api/vocabulary", response_model=List[VocabularyEntry])
...
@router.delete("/api/vocabulary/{word}")
